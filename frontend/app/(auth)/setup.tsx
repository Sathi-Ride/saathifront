...
const styles = StyleSheet.create({
  ...
  input: { width: "100%", height: 56, borderWidth: 2, borderColor: "#e0e0e0", borderRadius: 12, paddingHorizontal: 16, fontSize: 16, backgroundColor: "#fff", color: "#333" },
  inputFocused: { borderColor: "#8DBCC7", backgroundColor: "#f8fcfd" },
  inputPrefilled: { backgroundColor: "#f8f9fa", borderColor: "#d0d7de", color: "#666" },
  button: { width: "100%", backgroundColor: "#075B5E", borderRadius: 12, marginTop: 8, elevation: 2, shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4 },
  buttonDisabled: { backgroundColor: "#ccc", elevation: 0 },
  buttonContent: { height: 56, justifyContent: "center", alignItems: "center" },
  buttonText: { fontSize: 16, fontWeight: "600", color: "#fff" },
  helpText: { fontSize: 14, color: "#666", textAlign: "center", marginTop: 16, lineHeight: 20, paddingHorizontal: 20 },
  keyboardPlaceholder: { height: 100 },
  successContainer: { flex: 1, justifyContent: "center", alignItems: "center", paddingHorizontal: 20 },
  successIcon: { marginBottom: 24 },
  successTitle: { fontSize: 28, fontWeight: "700", color: "#333", textAlign: "center", marginBottom: 12 },
  successSubtitle: { fontSize: 16, color: "#666", textAlign: "center", marginBottom: 32, lineHeight: 22 },
  verifiedInfoContainer: { width: "100%", backgroundColor: "#f8f9fa", borderRadius: 16, padding: 20, marginBottom: 32, gap: 16 },
  verifiedItem: { flexDirection: "row", alignItems: "center", gap: 12 },
  verifiedText: { fontSize: 16, color: "#333", flex: 1 },
  verifiedBadge: { marginLeft: "auto" },
  getStartedButton: { width: "100%", backgroundColor: "#075B5E", borderRadius: 12, flexDirection: "row", alignItems: "center", justifyContent: "center", paddingVertical: 16, paddingHorizontal: 24, elevation: 2, shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4 },
  getStartedButtonText: { fontSize: 16, fontWeight: "600", color: "#fff", marginRight: 8 },
